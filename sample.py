...
def load_normalized_test_case(data_path, pagelocked_buffer, case_num=randint(0, 9)):
    ...
    img = np.array(cv2.imread(test_case_path,cv2.IMREAD_UNCHANGED))#.ravel()
...
def main():
    #data_path, _ = common.find_sample_data(description="Runs an MNIST network using a UFF model file", subfolder="data")
    data_path = "data/"
...
if __name__ == '__main__':
    main()
    #build_engine('models/lenet5.uff')
